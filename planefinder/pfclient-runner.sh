...
echo " - PLANEFINDER_LATITUDE =${ADSB_LATITUDE}"
echo " - PLANEFINDER_LONGITUDE=${ADSB_LONGITUDE}"
end_secion_spacer
...
sed -i "s/PLANEFINDER_LATITUDE/${ADSB_LATITUDE}/" /etc/pfclient-config.json
sed -i "s/PLANEFINDER_LONGITUDE/${ADSB_LONGITUDE}/" /etc/pfclient-config.json
end_secion_spacer
